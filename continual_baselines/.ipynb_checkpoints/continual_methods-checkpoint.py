...
class EWC(object):
    def __init__(self, model, trainData, trainLabels, device, criterion, optimizer, importance):
    ...
    def change_optimizer_on_task(self, optimizer):
        self.optimizer = optimizer
...
class SI(object):
    ...
    def train(self, model):
        ...
        for n, p in model.feature_extractor.items():
...
class LwF(object):
    def __init__(self, model, trainData, trainLabels, device, optimizer, importance):
        self.model = model
        self.data = trainData
        self.labels = trainLabels
        self.device = device
