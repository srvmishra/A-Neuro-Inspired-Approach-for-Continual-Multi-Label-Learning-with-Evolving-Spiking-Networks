...
def load_dataset(config):
    ...
    '''
    if config.name == 'yeast' or config.name == 'yeast_big':
...
#         print("labels = ", sum(labels_list) == train_labels.shape[1])
#         print("train data = ", sum(train_instance_list) == train_labels.shape[0])
    elif config.name == 'birds':
        train_path = '../../datasets/birds/birds-train.mat'
        test_path = '../../datasets/birds/birds-test.mat'
        train_ = loadmat(train_path)
        test_ = loadmat(test_path)
        train_data, train_labels = train_['data'], train_['labels']
        test_data, test_labels = test_['data'], test_['labels']
...
#         print("labels = ", sum(labels_list) == train_labels.shape[1])
#         print("train data = ", sum(train_instance_list) == train_labels.shape[0])
    elif config.name == 'enron':
        train_path = '../../datasets/enron/enron-train.arff'
        test_path = '../../datasets/enron/enron-test.arff'
        train_data = arff.load(open(train_path, 'rt'))
        train_data = np.array(train_data['data']).astype(np.float32)
        test_data = arff.load(open(test_path, 'rt'))
        test_data = np.array(test_data['data']).astype(np.float32)
...
#         print("labels = ", sum(labels_list) == train_labels.shape[1])
#         print("train data = ", sum(train_instance_list) == train_labels.shape[0])
    elif config.name == 'medical':
        train_path = '../../datasets/medical/medical-train.arff'
        test_path = '../../datasets/medical/medical-test.arff'
        train_data = arff.load(open(train_path, 'rt'))
        train_data = np.array(train_data['data']).astype(np.float32)
        test_data = arff.load(open(test_path, 'rt'))
        test_data = np.array(test_data['data']).astype(np.float32)
    elif config.name == 'CAL500':
        train_path = '../../datasets/CAL500/CAL500-train.mat'
        test_path = '../../datasets/CAL500/CAL500-test.mat'
        train_ = loadmat(train_path)
        test_ = loadmat(test_path)
        train_data, train_labels = train_['data'], train_['labels']
        test_data, test_labels = test_['data'], test_['labels']
        train_data = np.hstack([train_data, train_labels])
        test_data = np.hstack([test_data, test_labels])
    elif config.name == 'mediamill_20' or config.name == 'mediamill_50':
...
#         print("labels = ", sum(labels_list) == train_labels.shape[1])
#         print("train data = ", sum(train_instance_list) == train_labels.shape[0])
    elif config.name == 'delicious_20' or config.name == 'delicious_50':
        train_path = '../../datasets/delicious/delicious-train.arff'
        test_path = '../../datasets/delicious/delicious-test.arff'
        train_data = arff.load(open(train_path, 'rt'))
        train_data = np.array(train_data['data']).astype(np.float32)
        test_data = arff.load(open(test_path, 'rt'))
        test_data = np.array(test_data['data']).astype(np.float32)
...
#         print("labels = ", sum(labels_list) == train_labels.shape[1])
#         print("train data = ", sum(train_instance_list) == train_labels.shape[0])
    elif config.name == 'foodtruck' or config.name == 'foodtruck_big':
